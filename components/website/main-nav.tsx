...
const MainNav = () => {
  return (
    <div className='relative top-0 z-10 bg-white px-6 py-5  dark:border-white/10 dark:bg-zinc-950 lg:z-10 lg:flex lg:h-14 lg:items-center lg:px-8 lg:py-0 border-b'>
